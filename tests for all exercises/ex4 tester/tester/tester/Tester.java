...
public class Tester {
	public static void main(String[] args) {
		...
		String inputsDir = testerDir + "/input";
		String outputsDir = testerDir + "/output";
		String expectedOutputsDir = testerDir + "/expected_output"; // Add path for expected output
		String compilerJar = "../ANALYZER"; // Navigate up from 'tester' to 'ex4' directory
